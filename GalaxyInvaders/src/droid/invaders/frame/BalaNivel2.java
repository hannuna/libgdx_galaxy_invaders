...
public class BalaNivel2 extends DynamicGameObject {
	...
	public final static int VIDA=4;
	 ...
	 */
	public BalaNivel2(float x, float y) {
	...
	public BalaNivel2(float x,float y,boolean disparoAlien){
		super(x, y, WIDTH, HEIGHT);
		state=STATE_DISPARADO;
		stateTime=0;
